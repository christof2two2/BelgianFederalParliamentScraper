...
class introScraper(chapterScraper):
    ...
    def getDayMonthYear(self,text:str):
        ...
        monthDict = {1:"januari|janvier",2:"februari|février",3:"maart|mars",4:"april|avril",5:"mei|may",6:"juni|juin",
        7:"juli|juillet",8:"augustus|aout",9:"september|septembre",10:"oktober|octobre",11:"november|novembre",12:"december|décembre"}
        month = None
    ...
    def parse(self,elements):
        ...
        try:
            ...
            if i ==-1:
                raise exceptions.couldNotFind("could not find table with meeting time and organization info")
            rows = elements[i].xpath(".//tr")
            #scrape org name
            ...
            self.data["day"],self.data["month"],self.data["year"]=self.getDayMonthYear(self.data["fullDatenl"])
